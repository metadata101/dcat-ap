...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern>
    <sch:title>$loc/strings/dcat-ap-vl-rec.pattern.title.1</sch:title>
    <sch:rule context="//dcat:Dataset[$profile]|//dcat:DataService[$profile]">
      ...
      <sch:assert test="$dataThemes &gt; 0">$loc/strings/dcat-ap-vl-rec.pattern.assert.1</sch:assert>
      <sch:report test="$dataThemes &gt; 0">$loc/strings/dcat-ap-vl-rec.pattern.report.1</sch:report>
    </sch:rule>
  </sch:pattern>
</sch:schema>