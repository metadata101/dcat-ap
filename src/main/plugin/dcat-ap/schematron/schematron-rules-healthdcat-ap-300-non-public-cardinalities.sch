...
<schema xmlns="http://purl.oclc.org/dsdl/schematron">
  <title>{$loc/strings/healthdcat-ap-300-non-public-cardinalities.000000.schematron}</title>
  ...
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000001.title</title>
    <rule context="//time:TemporalEntity">
      <assert test="count(dct:description) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000002.assert, ('#occurrences'), (string(count(dct:description))))" />
      </assert>
      <report test="count(dct:description) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000003.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000016.title</title>
    <rule context="//vcard:Kind">
      <assert test="count(vcard:hasURL|vcard:hasEmail) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000017.assert, ('#occurrences'), (string(count(vcard:hasURL|vcard:hasEmail))))" />
      </assert>
      <report test="count(vcard:hasURL|vcard:hasEmail) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000018.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000019.title</title>
    <rule context="//vcard:Kind">
      <assert test="count(vcard:hasEmail) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000020.assert, ('#occurrences'), (string(count(vcard:hasEmail))))" />
      </assert>
      <report test="count(vcard:hasEmail) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000021.report, ('#max'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000022.title</title>
    <rule context="//vcard:Kind">
      <assert test="count(vcard:hasURL) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000023.assert, ('#occurrences'), (string(count(vcard:hasURL))))" />
      </assert>
      <report test="count(vcard:hasURL) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000024.report, ('#max'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000025.title</title>
    <rule context="//dcat:DatasetSeries">
      <assert test="count(dcatap:applicableLegislation) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000026.assert, ('#occurrences'), (string(count(dcatap:applicableLegislation))))" />
      </assert>
      <report test="count(dcatap:applicableLegislation) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000027.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000028.title</title>
    <rule context="//dcat:Dataset">
      <assert test="count(dcat:theme) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000029.assert, ('#occurrences'), (string(count(dcat:theme))))" />
      </assert>
      <report test="count(dcat:theme) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000030.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000031.title</title>
    <rule context="//dcat:Distribution">
      <assert test="count(dcatap:applicableLegislation) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000032.assert, ('#occurrences'), (string(count(dcatap:applicableLegislation))))" />
      </assert>
      <report test="count(dcatap:applicableLegislation) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000033.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000034.title</title>
    <rule context="//csvw:Column">
      <assert test="count(csvw:propertyUrl) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000035.assert, ('#occurrences'), (string(count(csvw:propertyUrl))))" />
      </assert>
      <report test="count(csvw:propertyUrl) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000036.report, ('#max'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000037.title</title>
    <rule context="//csvw:Column">
      <assert test="count(csvw:datatype) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000038.assert, ('#occurrences'), (string(count(csvw:datatype))))" />
      </assert>
      <report test="count(csvw:datatype) &lt;= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000039.report, ('#max'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000040.title</title>
    <rule context="//csvw:Column">
      <assert test="count(csvw:datatype) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000041.assert, ('#occurrences'), (string(count(csvw:datatype))))" />
      </assert>
      <report test="count(csvw:datatype) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000042.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
  ...
  <pattern>
    <title>$loc/strings/healthdcat-ap-300-non-public-cardinalities.000046.title</title>
    <rule context="//csvw:Column">
      <assert test="count(dct:description) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000047.assert, ('#occurrences'), (string(count(dct:description))))" />
      </assert>
      <report test="count(dct:description) >= 1">
        <value-of select="geonet:replacePlaceholders($loc/strings/healthdcat-ap-300-non-public-cardinalities.000048.report, ('#min'), '1')" />
      </report>
    </rule>
  </pattern>
  <pattern>
