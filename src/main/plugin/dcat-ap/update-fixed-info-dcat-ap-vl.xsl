...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="update-fixed-info-profile" match="dcat:CatalogRecord/dct:conformsTo/dct:Standard[$profile = $dcatapvlURI]">
    <dct:Standard rdf:about="https://data.vlaanderen.be/doc/applicatieprofiel/DCAT-AP-VL/erkendestandaard/2019-10-03">
      ...
      <dct:description xml:lang="de">Dieses Anwendungsprofil beschreibt Open Data-Kataloge in Flandern. DCAT-AP Flandern (DCAT-AP VL) ist eine weitere Spezialisierung von DCAT-AP. Die Anwendung, auf die sich dieses Profil bezieht, ist ein Open Data-Portal in Flandern. Open Data-Portale sind Kataloge mit Open Data-Datensätzen. Ihr Hauptzweck besteht darin, Daten auffindbar zu machen und so ihre Wiederverwendung zu fördern. Open Data-Portale spielen eine zentrale Rolle bei der Mission der Regierung, Zugang zu Regierungsinformationen zu erreichen. Mit diesem Anwendungsprofil fördern wir die Einheitlichkeit der verfügbaren Informationen über alle Datensätze hinweg. Wir vereinfachen außerdem den Aggregationsprozess mehrerer Open Data-Kataloge. Dieses Dokument enthält die obligatorischen Elemente und zusätzliche Elemente, zu denen DCAT-AP Flandern eine Stellungnahme abgibt. Empfohlene und optionale Informationen, für die im Rahmen von DCAT-AP Flandern keine zusätzlichen Vereinbarungen bestehen, sind in diesem Dokument nicht enthalten. Hierzu verweisen wir auf die DCAT-AP-Spezifikation selbst.</dct:description>
  ...
  <xsl:template mode="update-fixed-info-profile" match="dcat:CatalogRecord/dct:conformsTo/dct:Standard[$profile = $metadatadcatURI]">
    <dct:Standard rdf:about="https://data.vlaanderen.be/doc/applicatieprofiel/metadata-dcat/erkendestandaard/2021-04-22">
      ...
      <dct:description xml:lang="de">Das Anwendungsprofil "Metadata DCAT". Dieses Anwendungsprofil basiert auf DCAT und konzentriert sich auf die Erfassung von Informationen über generische Datensätze, Distributionen und Dienste, die von einer Regierung bereitgestellt werden. Die Datensätze und Dienste umfassen sowohl öffentlich zugängliche als auch private Daten und Dienste (entwickelt in und für beliebige technische Perspektiven). Die Zusammenfassung all dieser Informationen in einem Katalog erhöht die Auffindbarkeit dieser Datensätze und Dienste. Dieses Anwendungsprofil ist das generische Basisprofil. Abgeleitete Profile können selbstverständlich für spezifische Domänen oder Communities erstellt werden. Beispielsweise ist DCAT-AP-VL ein solches abgeleitetes Anwendungsprofil speziell für den Open-Data-Bereich und die zugehörige Community.</dct:description>
