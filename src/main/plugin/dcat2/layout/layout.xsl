...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- &lt;!&ndash; Ignore all gn element &ndash;&gt; -->
  <!-- <xsl:template mode="mode-dcat2" match="gn:*|@gn:*|@*" priority="1000"/> -->

  <!-- &lt;!&ndash; Template to display non existing element ie. geonet:child element -->
  <!-- of the metadocument. Display in editing mode only and if -->
  <!-- the editor mode is not flat mode. &ndash;&gt; -->
  ...
  <!--   &lt;!&ndash; TODO: this should be common to all schemas &ndash;&gt; -->
  ...
  <!--       &lt;!&ndash; TODO: add xpath and isoType to get label ? &ndash;&gt; -->
  ...
  <!--       &lt;!&ndash; <xsl:with-param name="isForceLabel" select="true()"/> &ndash;&gt; -->
  <!--     </xsl:call-template> -->
  <!--   </xsl:if> -->
  <!-- </xsl:template> -->
  ...
  <!--     &lt;!&ndash; <xsl:with-param name="isSlideToggle" select="if ($isSupportingSlideToggle and $isDisplayingSections = false()) then 'true' else 'false'"/> &ndash;&gt; -->
  <!--     <xsl:with-param name="subTreeSnippet"> -->

  <!--       <xsl:if test="$isEditing"> -->
  <!--         &lt;!&ndash; Render attributes as fields and overwrite the normal behavior &ndash;&gt; -->
  ...
  <!--     &lt;!&ndash; Create a new configuration to only create -->
  <!--           a add action for non existing node. The add action for -->
  <!--           the existing one is below the last element. &ndash;&gt; -->
  ...
  <!-- &lt;!&ndash; Hide from the editor the dct:references pointing to uploaded files &ndash;&gt; -->
  ...
  <!-- &lt;!&ndash; the other elements in DC. &ndash;&gt; -->
  <!-- <xsl:template mode="mode-dcat2" priority="100" match="dc:*|dct:*|dcat:*|vcard:*|foaf:*|spdx:*|adms:*|owl:*|schema:*|skos:*|mdcat:*"> -->
  <!--   <xsl:param name="schema" select="$schema" required="no"/> -->
  <!--   <xsl:param name="labels" select="$labels" required="no"/> -->
  ...
  <!--   &lt;!&ndash; Render rdf:about attribute as field for dcat:Dataset &ndash;&gt; -->
  ...
  <!--   &lt;!&ndash; Add view and edit template&ndash;&gt; -->
  ...
  <!--       &lt;!&ndash; <xsl:variable name="isForceLabel" select="$fieldNode/@forceLabel"/> &ndash;&gt; -->
  <!--       <xsl:variable name="currentNode" select="." /> -->
  <!--       &lt;!&ndash; Check if template field values should be in -->
  <!--       readonly mode in the editor.&ndash;&gt; -->
  ...
  <!--         &lt;!&ndash;xsl:with-param name="name" select="$strings/*[name() = $name]" /&ndash;&gt; -->
  ...
  <!--         &lt;!&ndash; <xsl:with-param name="isFirst" select="$isForceLabel and count(preceding-sibling::*[name() = $name]) = 0"/> &ndash;&gt; -->
  <!--       </xsl:call-template> -->
  <!--     </xsl:when> -->
  <!--     <xsl:otherwise> -->
  <!--       <xsl:variable name="xpath" select="gn-fn-metadata:getXPath(.)"/> -->
  ...
  <!--         <xsl:with-param name="cls" select="local-name()"/> -->
  <!--         &lt;!&ndash;<xsl:with-param name="widget"/> -->
  <!--               <xsl:with-param name="widgetParams"/>&ndash;&gt; -->
  <!--         <xsl:with-param name="xpath" select="$xpath"/> -->
  <!--         &lt;!&ndash;xsl:with-param name="forceDisplayAttributes" select="gn-fn-dcat2:isForceDisplayAttributes(.)"/&ndash;&gt; -->
  <!--         &lt;!&ndash;xsl:with-param name="attributesSnippet" select="$attributes"/&ndash;&gt; -->
  ...
  <!--         &lt;!&ndash; When adding an element, the element container contains -->
  <!--         information about cardinality. &ndash;&gt; -->
  ...
  <!--         &lt;!&ndash; Boolean that allow to show the mandatory "*" in black instead of red &ndash;&gt; -->
  <!--         &lt;!&ndash; <xsl:with-param name="subRequired" select="(name() = 'vcard:street-address' and name(..) = 'vcard:Address') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'vcard:locality' and name(..) = 'vcard:Address') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'vcard:postal-code' and name(..) = 'vcard:Address') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'vcard:country-name' and name(..) = 'vcard:Address') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'foaf:name' and ../../name() = 'dct:publisher') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'foaf:name' and name(..) = 'foaf:Document') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'skos:notation' and name(..) = 'adms:Identifier') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'spdx:algorithm' and name(..) = 'spdx:Checksum') or &ndash;&gt; -->
  <!--         &lt;!&ndash;                                            (name() = 'spdx:checksumValue' and name(..) = 'spdx:Checksum')"/> &ndash;&gt; -->
  <!--       </xsl:call-template> -->
  ...
  <!-- &lt;!&ndash; Hide from the editor in default view &ndash;&gt; -->
  ...
  <!-- &lt;!&ndash; Ignore the following attributes in flatMode &ndash;&gt; -->
  ...
  <!--     <xsl:with-param name="listOfValues" select="$helper"/> -->
  <!--     &lt;!&ndash; <xsl:with-param name="subRequired" select="(name() = 'rdf:about' and name(..) = 'dct:LicenseDocument')"/> &ndash;&gt; -->
  <!--   </xsl:call-template> -->
  <!-- </xsl:template> -->
