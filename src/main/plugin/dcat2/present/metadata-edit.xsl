...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="metadata-dcat2view-simple" match="metadata-dcat2view-simple">
    ...
    <xsl:call-template name="md-content">
      ...
      <xsl:with-param name="relatedResources">
        <xsl:call-template name="dcat2-relatedResources"/>
      </xsl:with-param>
      <xsl:with-param name="tabs">
        <xsl:call-template name="complexElementSimpleGui">
          ...
          <xsl:with-param name="content">
            <xsl:apply-templates mode="dcat2" select=".">
              <xsl:with-param name="schema" select="'dcat2'"/>
  ...
  -->
  <xsl:template name="dcat2-relatedResources">
    <table class="related">
      <tbody>
  ...
  <xsl:template mode="dcat2" match="dct:description|dct:rights|dct:title">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
  ...
  <xsl:template mode="dcat2" match="dct:spatial">
    <xsl:param name="schema"/>
    <xsl:param name="edit"/>
