...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-metadata-dcat-language">
  ...
  <xsl:template name="get-metadata-dcat-other-languages-as-json">
    <xsl:variable name="langs">
    <xsl:variable name="mainLanguage">
      <xsl:call-template name="get-metadata-dcat-language"/>
    </xsl:variable>
    <lang>
  ...
  <xsl:template name="get-metadata-dcat-other-languages">
  <xsl:choose>
