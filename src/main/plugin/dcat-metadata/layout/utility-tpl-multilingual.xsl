...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-dcat-metadata-language">
  ...
  <xsl:template name="get-dcat-metadata-other-languages-as-json">
    <xsl:variable name="langs">
    <xsl:variable name="mainLanguage">
      <xsl:call-template name="get-dcat-metadata-language"/>
    </xsl:variable>
    <lang>
  ...
  <xsl:template name="get-dcat-metadata-other-languages">
  <xsl:choose>
