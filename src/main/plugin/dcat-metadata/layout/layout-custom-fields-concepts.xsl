...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template mode="mode-dcat-metadata" priority="2000" match="foaf:Agent/dct:type|
    ...
    <xsl:variable name="createdInSchemeByParentElementName" select="gn-fn-dcat-metadata:getInSchemeURIByElementName(name(.),name(..))"/>
    ...
    <xsl:variable name="thesaurusTitle" select="gn-fn-dcat-metadata:getThesaurusTitle($inScheme)"/>
    <xsl:variable name="thesaurusIdentifier" select="gn-fn-dcat-metadata:getThesaurusIdentifier($inScheme)"/>
  ...
  <xsl:template mode="mode-dcat-metadata" match="skos:Concept" priority="2000">
