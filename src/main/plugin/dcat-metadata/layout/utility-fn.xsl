...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:function name="gn-fn-dcat-metadata:getRdfTypeByElementName" as="xs:string">
    <xsl:param name="elementName"/>
    <xsl:param name="parentElementName"/>
    <xsl:choose>
      <xsl:when test="$elementName = 'dct:type' and $parentElementName = 'foaf:Agent'">
  ...
  <xsl:function name="gn-fn-dcat-metadata:getThesaurusTitle" as="xs:string">
  ...
  <xsl:function name="gn-fn-dcat-metadata:getThesaurusIdentifier" as="xs:string">
    <xsl:param name="resource"/>
    <xsl:choose>
      <xsl:when test="$resource = concat($inSchemeAdmsBaseUrl,'publishertype/1.0')">
  ...
  <xsl:function name="gn-fn-dcat-metadata:isNotMultilingualField" as="xs:boolean">
  ...
  -->
  <xsl:function name="gn-fn-dcat-metadata:getField" as="node()">
  ...
  <xsl:function name="gn-fn-dcat-metadata:isForceDisplayAttributes" as="xs:boolean">
    <xsl:param name="element" as="node()"/>
    <xsl:choose>
  ...
  <xsl:function name="gn-fn-dcat-metadata:getBboxCoordinates" as="xs:string">
  ...
  <xsl:function name="gn-fn-dcat-metadata:concatXPaths" as="xs:string">
